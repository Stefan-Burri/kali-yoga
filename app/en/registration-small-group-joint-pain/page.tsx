...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Small Group Registration – Joint Pain | Kali Yoga Bern",
    description: "Register for the small group course on holistic support for joint pain at Kali Yoga Bern.",
  };
}
...
export default async function RegistrationSmallGroupJointPain() {
        ...
        <div className="mx-auto max-w-[1280px] px-6">
          <GlassCard>
            <div className="text-center max-w-[768px] mx-auto mb-12">
              <p className="text-body text-foreground/60 uppercase tracking-wider mb-3">Holistic support for joint pain</p>
