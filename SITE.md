...
## Recent Changes
- 2026-08-03: Newsletter-Formular um **Vorname + Nachname** ergänzt (beide Pflichtfelder, DE «Vorname/Nachname», EN «First name/Last name») — die beiden Felder stehen nebeneinander über dem E-Mail-Feld (auf dem Handy gestapelt). Der Name erscheint in der Anmelde-E-Mail an info@kali-yoga.ch als «Name: Vorname Nachname»
- 2026-08-03: Seitentitel auf dem Handy grösser als Abschnitts-Titel — die Handy-Variante der Bogen-Titel (z.B. «Yogaklassen») verwendet jetzt die Seitentitel-Grösse (h1, ab 40px) statt der Abschnitts-Grösse; der Startseiten-Titel «Yoga for Every Body» bleibt bewusst eine Stufe kleiner (Juli-Entscheid). Ausserdem: «Kleinere Überschrift»-Schalter auf allen 6 Versicherungs-Sektionen (DE+EN) ausgeschaltet — «Kostenübernahme/Kostenbeteiligung Zusatzversicherung» ist jetzt gleich gross wie alle anderen Abschnitts-Titel; der Schalter bleibt im Studio verfügbar
- 2026-08-03: Stundenplan-Header strukturell wie das Kontaktformular — der grosse separate Hero-Titel wurde entfernt; der Titel («Stundenplan Yogaklassen Bern» / EN «Yoga Class Schedule Bern») steht jetzt als Seitentitel mit Goldlinie und Einleitung direkt in der Glaskarte der Stundenplan-Sektion (DE /stundenplan, EN /en/schedule). Nebenbei: Einleitungen unter Sektions-Titeln respektieren jetzt Zeilenumbrüche aus dem CMS
- 2026-08-03: Neuer CMS-Baustein **«Galerie-Slider (Fotos)»** — quadratische Foto-Kacheln in einer horizontal wischbaren Reihe (Pfeil-Knöpfe auf Desktop), Klick öffnet eine Lightbox (Vollbild mit Vor/Zurück, Zähler, Schliessen per ✕ oder Esc). Fotos werden direkt im Studio hochgeladen («Fotos hochladen»); optional Überschrift + Einleitung. Auf jeder DE/EN-Seite einsetzbar; noch auf keiner Seite platziert — im Studio bei einer Seite unter «Sektionen (Baukasten)» hinzufügen und Fotos hochladen
- 2026-08-03: Sektions-Überschriften vereinheitlicht — alle Sektionstitel verwenden jetzt dieselbe Grösse «Abschnitts-Titel» (30–45px, responsive); vorher waren Feedback-, Anmelde-Aufruf-, Newsletter- und Text&Bild-Titel eine Stufe kleiner. Ausnahme bleibt der bewusste Schalter «Kleinere Überschrift» in der About-Sektion (Versicherungs-Titel)
- 2026-08-03: Neuer CMS-Baustein **«Newsletter-Sektion (E-Mail-Anmeldung)»** — Überschrift + Goldlinie + Einleitung + E-Mail-Feld mit Anmelden-Button (einzeilig auf Desktop, gestapelt auf dem Handy), darunter kleiner Datenschutz-Hinweis mit Link. Anmeldungen gehen als E-Mail «Newsletter Anmeldung» an info@kali-yoga.ch (gleicher Versandweg wie die anderen Formulare, inkl. Spam-Schutz). Im Studio auf jeder DE/EN-Seite einsetzbar; bearbeitbar sind Überschrift, Einleitung, Button-Text und Darstellung. Als Vorschlag ganz unten auf der Startseite platziert (nach den FAQ) — kann im Studio verschoben oder entfernt werden. Hinweis: Die eingehenden E-Mail-Adressen müssen vorerst manuell in einer Liste gesammelt werden; ein richtiges Newsletter-Tool (z.B. Mailchimp/Brevo) kann später angebunden werden
- 2026-08-03: Neuer CMS-Baustein **«FAQ-Sektion (aufklappbare Fragen)»** — einspaltige Liste von Fragen, die per Klick aufklappen (Frage in Lila mit goldenem Pfeil, sanfte Auf-/Zuklapp-Animation, Glas-Box wie die übrigen Sektionen). Im Studio unter «Sektionen (Baukasten)» auf jeder deutschen und englischen Seite einsetzbar; pro Frage gibt es «Frage» (Text) und «Antwort» (formatierbar). Die Fragen werden zusätzlich als FAQ-Strukturdaten an Google übermittelt (können direkt im Suchresultat erscheinen — gut für SEO). Erste Anwendung: 6 häufige Fragen ganz unten auf der Startseite (Eignung, Mitbringen, Anmeldung, Preise, Krankenkasse, Standort)
- 2026-08-03: Datenschutzerklärung in Ich-Form — da Kali Yoga eine Einzelperson ist, wurde «wir/uns» durchgehend durch «ich/mich» ersetzt (DE /datenschutz und EN /en/privacy-policy, direkt im CMS geändert und veröffentlicht)
- 2026-08-03: Silbentrennung in Überschriften nur noch bei sehr langen Wörtern — vorher trennte das Handy auch kurze Wörter («Yoga The-rapie», «Yo-gaklassen»); jetzt rutschen normale Wörter als Ganzes auf die nächste Zeile, nur Wörter ab 13 Buchstaben (z.B. «Zusatzversicherung») werden getrennt, mit mindestens 6 Buchstaben vor/nach dem Trennstrich
- 2026-08-03: Datenschutz/Impressum ohne Einblend-Animation — die langen Rechtstexte blieben auf dem Handy unsichtbar, weil die Scroll-Animation nie auslöste (bei sehr hohen Abschnitten wurden die nötigen 15 % Sichtbarkeit nie erreicht). Betroffene Seiten (DE: /datenschutz, /impressum; EN: /privacy-policy) zeigen den Text jetzt sofort ohne Animation; zusätzlich wurde die Scroll-Animation generell so korrigiert, dass auch andere sehr lange Abschnitte auf kleinen Bildschirmen zuverlässig erscheinen. Ausserdem: ausgewogene Zeilenumbrüche für alle Texte — Überschriften und Zitate brechen in etwa gleich lange Zeilen (text-wrap: balance), Fliesstext vermeidet einzelne Wörter allein auf der letzten Zeile (text-wrap: pretty)
