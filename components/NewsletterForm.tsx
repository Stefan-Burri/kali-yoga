...
/**
 * NewsletterForm — one email field + submit button. Submissions go through
 * /api/contact (Resend → info@kali-yoga.ch) with the same honeypot and
 * timing spam guards as the other forms.
 */
